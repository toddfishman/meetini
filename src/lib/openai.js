...
exports.parseMeetingRequest = parseMeetingRequest;
exports.transcribeAudio = transcribeAudio;
function parseMeetingRequest(prompt) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    return [4 /*yield*/, fetch("".concat(process.env.NEXT_PUBLIC_APP_URL, "/api/ai/parse-meeting"), {
                            method: 'POST',
                            headers: {
...
function transcribeAudio(audioBlob) {
    return __awaiter(this, void 0, void 0, function () {
        var formData, finalBlob, response, error, data, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    ...
                    return [4 /*yield*/, fetch('/api/ai/transcribe', {
                            method: 'POST',
                            body: formData,
                        })];
                case 1:
